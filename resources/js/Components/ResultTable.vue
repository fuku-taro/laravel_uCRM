...
<template>
  <div v-if="data.type === 'perDay' || data.type === 'perMonth' || data.type === 'perYear'" class="mt-3 lg:w-2/3 w-full mx-auto overflow-auto">
  ...
  <div v-if="data.type === 'decile'" class="mt-3 lg:w-2/3 w-full mx-auto overflow-auto">
    <table class="table-auto w-full text-left whitespace-no-wrap">
      <thead>
        <tr>
  ...
  <div v-if="data.type === 'rfm'" class="mt-3 lg:w-2/3 w-full mx-auto overflow-auto">
