                    ...
                    <div class="container px-5 py-8 mx-auto">
                      <div class="lg:w-1/2 md:w-2/3 mx-auto">
                        <div class="flex flex-wrap -m-2">
                          ...
                          <div class="p-2 w-full">
                            <div class="relative">
                              <label for="is_selling" class="leading-7 text-sm text-gray-600">性別</label>
                              <br>
                              ...
                              <label for="gender2" class="ml-2 mr-4">女性</label>
                              <input type="radio" id="gender3" name="gender" v-model="form.gender" value="2">
                              <label for="gender3" class="ml-2 mr-4">無回答</label>
                            </div>
                          </div>
